...
import 'package:beehub_flutter_app/Screens/AccountSetting/account_setting_page.dart';
...
import 'Screens/AccountSetting/account_setting_page.dart';
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      getPages: [
        ...
        GetPage(name: '/account_setting', page: ()=> const AccountSettingPage()),
